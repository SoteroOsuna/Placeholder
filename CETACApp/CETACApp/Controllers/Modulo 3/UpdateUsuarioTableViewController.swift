//
//  UpdateUsuarioTableViewController.swift
//  CETACApp
//
...
class UsuariosUpdateTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "usuarioCell", for: indexPath) as! UsuariosTableViewCell
...
//        cell.textLabel?.text = datos[indexPath.row].nombre
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "updateUser"{
            let siguiente = segue.destination as! UpdateScreenViewController
