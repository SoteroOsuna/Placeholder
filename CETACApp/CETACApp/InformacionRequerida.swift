...
let listaIntervencion = ["Acompañamiento Grupal", "Acompañamiento Individual", "Angeloterapia", "Aromaterapia y Musicoterapia", "Biomagnetismo", "Brisas Ambientales", "Cama Térmica de Jade", "Cristaloterapia", "Flores de Bach", "Logoterapia", "Mindfulness", "Reiki", "Tanatología"]
